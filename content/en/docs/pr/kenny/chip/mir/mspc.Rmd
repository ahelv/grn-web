...
nets <- c('data/network/gl/kna-mspc-s0.rds', 'data/network/gl/kna-mspc-s1.rds',
         'data/network/gl/kna-mspc-s2.rds', 'data/network/gl/kna-mspc-s4.rds',
         'data/network/gl/kna-mspc-s8.rds')
```
