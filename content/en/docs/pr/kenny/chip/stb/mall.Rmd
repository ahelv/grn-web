...
nets <- c('data/network/gl/kna-mall-s0.rds', 'data/network/gl/kna-mall-s1.rds',
         'data/network/gl/kna-mall-s2.rds', 'data/network/gl/kna-mall-s4.rds',
         'data/network/gl/kna-mall-s8.rds')
```
