...
nets <- c('data/network/gl/kna-mpsc-s0.rds', 'data/network/gl/kna-mpsc-s1.rds',
         'data/network/gl/kna-mpsc-s2.rds', 'data/network/gl/kna-mpsc-s4.rds',
         'data/network/gl/kna-mpsc-s8.rds')
```
